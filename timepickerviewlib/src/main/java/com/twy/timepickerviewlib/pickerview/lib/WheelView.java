package com.twy.timepickerviewlib.pickerview.lib;
...
import com.twy.timepickerviewlib.pickerview.adapter.WheelAdapter;
...
//            mGravity = a.getInt(R.styleable.wheelview_gravity, Gravity.CENTER);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < itemsVisible) {
            canvas.save();
            // ILog(弧长)=α（弧度）* r(半径) （弧度制）
            // 求弧度--> (ILog * π ) / (π * r)   (弧长X派/半圆周长)
