 ...
 * @since 2013-8-15
 */
public class PullToRefreshNoScrollListView extends PullToRefreshBase<NoScrollListView> implements OnScrollListener {
     ...
     */
    public PullToRefreshNoScrollListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    @Override
    protected NoScrollListView createRefreshableView(Context context, AttributeSet attrs) {
        NoScrollListView listView = new NoScrollListView(context);
        mListView = listView;
