...
public class PullToRefreshExpandableListView extends PullToRefreshBase<ExpandableListView> implements OnScrollListener {
    ...
    protected ExpandableListView createRefreshableView(Context context, AttributeSet attrs) {
        ...
        mListView = listView;
        mListView.setOverScrollMode(ExpandableListView.OVER_SCROLL_NEVER);
    ...
    public void setHasMoreData(boolean hasMoreData) {
        if (!hasMoreData) {
            if (null != mLoadMoreFooterLayout) {
                mLoadMoreFooterLayout.setVisibility(VISIBLE);
    ...
    public void setHasMoreData(boolean hasMoreData,boolean isFristPage) {
        if (!hasMoreData) {
            if (null != mLoadMoreFooterLayout) {
                if(isFristPage){
                    mLoadMoreFooterLayout.setVisibility(GONE);
                }
                mLoadMoreFooterLayout.setState(ILoadingLayout.State.NO_MORE_DATA);
            }
