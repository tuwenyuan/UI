...
public class SignatureView extends View {
    ...
    private int mMinWidth, mMaxWidth, mPointWidth;
    ...
    public SignatureView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            mMinWidth = a.getDimensionPixelSize(R.styleable.SignatureView_minWidth, UIUtils.dip2px(3));
            mMaxWidth = a.getDimensionPixelSize(R.styleable.SignatureView_maxWidth, UIUtils.dip2px(20));
            mPointWidth = a.getDimensionPixelSize(R.styleable.SignatureView_paintStrokeWidth, 10);
            pointColor = a.getColor(R.styleable.SignatureView_paintColor, Color.BLACK);
        } finally {
            a.recycle();
            mPointWidth = 10;
...
//                mPath.quadTo(moveCurrentX, moveCurrentY, downPoint[0], downPoint[1]);
    ...
    public Bitmap getPaintBitmap() {
        return getPaintBitmap(320, 480);
    }

    public Bitmap getPaintBitmap(int width, int height) {
        return resizeImage(mMBitmap, width, height);
    }
