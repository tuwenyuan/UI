    ...
    public void onClick(View v) {
        ...
        if (i == R.id.start) {
            ...
            if (TextUtils.isEmpty(url)) {
                Log.d(TAG, String.valueOf(R.string.no_url));
                //ToastUtils.showCenterToast( getResources().getString(R.string.no_url));
                return;
            }
...
//                                        }
                    ...
                    if (mChangeBrightness) {
                        ...
                        WindowManager.LayoutParams params = sActivity.getWindow().getAttributes();
                        ...
                        sActivity.getWindow().setAttributes(params);
                        //dialog中显示百分比
...
//            int duration = getDuration();
            ...
            sActivity.setRequestedOrientation(NORMAL_ORIENTATION);
    ...
    public void clearFullscreenLayout() {
        ViewGroup vp = (ViewGroup) (sActivity.getWindow().getDecorView())//.getWindow().getDecorView();
...
//                Log.v(TAG, "onProgressUpdate " + position + "/" + duration + " [" + this.hashCode() + "] ");
    ...
    public void startWindowFullscreen() {
        ...
        sActivity.setRequestedOrientation(FULLSCREEN_ORIENTATION);
        if (sActivity.getRequestedOrientation() != ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE) {
...
//    }
    ...
    public void autoFullscreen(float x) {
        if (isCurrentJcvd()
            ...
            if (x > 0) {
                sActivity.setRequestedOrientation(
